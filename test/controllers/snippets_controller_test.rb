...
class SnippetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create snippet" do
    assert_difference('Snippet.count') do
      post snippets_url, params: { snippet: { expires_in: @snippet.expires_in, name: @snippet.name, snippet: @snippet.snippet } }, as: :json
    end
  ...
  test "should update snippet" do
    patch snippet_url(@snippet), params: { snippet: { expires_in: @snippet.expires_in, name: @snippet.name, snippet: @snippet.snippet } }, as: :json
    assert_response 200
  end
